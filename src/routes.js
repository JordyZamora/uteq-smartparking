...
const Puestos = React.lazy(
  () => import('./views/parqueadero/Puestos'),
)
const RegistrosEstacionamiento = React.lazy(
  () => import('./views/parqueadero/RegistrosEstacionamiento'),
)
...
export const routes = [
  ...
  { path: '/parqueadero/puestos', name: 'Puestos', element: Puestos },
  {
    path: '/parqueadero/registros',
    name: 'Registros de estacionamiento',
    element: RegistrosEstacionamiento,
  },
]
